...
public class EasyConfiguration {
    ...
    private static final String SIMA2_PACKAGES_PREFIX = "com.dml.sima2";
    private static final Set<String> SIMA2_PACKAGES =
            Arrays.stream(Package.getPackages())
                    .map(Package::getName)
                    .filter(aPackage ->
                            aPackage.startsWith(SIMA2_PACKAGES_PREFIX))
    ...
    public EasyConfiguration(
        ...
        /* By design, sibling elements of the configuration element and itself
        are present in the list of reference resolvers for this element, for
        a reasonable use case consult card products as configured in
        com.dml.sima2.core.modules.FinancialEntityResolver */
